...
$all_recs = $clinic->select_all_mul_dental_rec($id);
?>
...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary"><a href="patient_history_dental.php" style="color: white;text-decoration:none">Back</a></button>
