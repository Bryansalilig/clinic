...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <nav>
                <div class="logo">
                    <p>DESPINGSING OF MEDICINE</p>
                </div>
            </nav><br><br><br><br>
            <button class="btn btn-primary"><a href="despensing.php" style="color: white;text-decoration:none">Medical Despensing</a></button>
            <button class="btn btn-success"><a href="dental_despensing.php" style="color: white;text-decoration:none">Dental Despensing</a></button>
        ...
        <tbody>
            ...
            <td style="display: none;"><?= $row['id']?></td>
                ...
                <td>
                    ...
                    include("connect.php");
                    $ids = $row['dental_id'];
                    $total_gallon = "SELECT COUNT(med_name) AS sum FROM `tbl_despensing` WHERE despensing_id = '$ids'";
                    ...
                    ?>
                    <?php echo $qty_gallon?> times
                </td>
                <td>
                <button type="button" class="btn btn-success"><a href="view_dental_despensing.php?id=<?= $ids?>" style="color: white;text-decoration:none">Despensing</a></button>
                </td>
            </tr>
            <?php }
            mysqli_close($conn);
