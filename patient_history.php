...
$total_gallon = "SELECT COUNT(f_name) AS sum FROM `tbl_discharge`";
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="patient_history.php" id="lop">
...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button type="button" class="btn btn-success"><a href="patient_history.php" style="color: white;text-decoration:none">Medical History</a></button>
            <button type="button" class="btn btn-primary"><a href="patient_history_dental.php" style="color: white;text-decoration:none">Dental History</a></button>
...
<table class="table" style="font-size: 20px;">
        ...
        <tbody>
            ...
            <td style="display: none;"><?= $row['med_id']?></td>
                ...
                <td style="display: none;"><?= $row['consult_type']?></td>
                ...
                <td>
                    ...
                    <input type="hidden" name="m_name" value="<?= $row['m_name']?>">
                    <input type="hidden" name="l_name" value="<?= $row['l_name']?>">
                    <input type="hidden" name="suffix" value="<?= $row['suffix']?>">
                <button type="button" class="btn btn-success"><a href="view_history.php?id=<?= $row['med_id']?>" style="color: white;text-decoration:none">History</a></button>
 
                <input type="hidden" name="discharge_update" value="<?= $medcount?>">
