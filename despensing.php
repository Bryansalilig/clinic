...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-success"><a href="despensing.php" style="color: white;text-decoration:none">Medical Despensing</a></button>
            <button class="btn btn-primary"><a href="dental_despensing.php" style="color: white;text-decoration:none">Dental Despensing</a></button>
...
<table class="table" style="font-size: 20px;">
        ...
        <tbody>
            ...
            <td style="display: none;"><?= $row['id']?></td>
                ...
                <td>
                <button type="button" class="btn btn-success"><a href="view_despensing.php?id=<?= $ids?>" style="color: white;text-decoration:none">Despensing</a></button>
                </td>
            </tr>
            <?php }
            mysqli_close($conn);
