...
$output = '';
$sql = "SELECT * FROM medical_records WHERE f_name LIKE '{$_POST['search']}%'";
...
<table class="table" style="font-size: 20px;">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <td>'.$row['phy'].'</td>
        <td>
        <button type="button" class="btn btn-success"><a href="addmed.php?id='.$row['med_id'].'" style="color:white;text-decoration:none"> + Med</button>
        </td>
    </tr>
