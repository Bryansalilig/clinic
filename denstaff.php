...
$clinic->add_dental_staff_record();
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">
                ...
                <form method="POST">
                    ...
                    <button type="submit" style="margin-left:20px" name="add_dental_staff_rec" class="btn btn-success" data-bs-dismiss="modal">+ Save</button>
                    <br><br>
                </form>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-success"><a href="medstaff.php" style="color: white;text-decoration:none;">+ Add Staff</a></button>
