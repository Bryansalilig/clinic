...
$id = $_GET['id'];
$record = $clinic->select_single_record($id);
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="margin-left:-120px;width: 150%;">
                <div class="modal-header">
                    <button type="button" class="btn btn-primary"><a href="medical.php" style="color: white;text-decoration: none;">X</a></button>
                </div>
                ...
                <form method="POST">
                    <div class="row">
                        <input type="hidden" name="gen_id" id="gen_id" value="<?= $record['med_id']?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="padding: 20px;">
                            ...
                            <select name="phy" id="phy" class="form-control">
                                <option value="">---</option>
                                <option value="Dr. Bryan Salilig">Dr. Bryan Salilig</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger"><a href="medical.php" style="color: white;text-decoration:none">Close</a></button>
                </div>
