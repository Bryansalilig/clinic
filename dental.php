...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM tbl_dental_records") or die(mysqli_error($conn));
...
// query stirng
$sql = "SELECT * FROM tbl_dental_records LIMIT $offset, $total_records_per_page";
// result
...
<body>
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="add_purok.php">
                            <i class='bx bx-buildings icon buildings'></i>
                            <span class="text nav-text">DESPENDING</span>
                        </a>
                    </li>
                    <li class="nav-link">
    ...
    <div class="modal" id="modalmed" tabindex="1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">

                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">ADD DENTAL</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                ...
                <form method="POST">
                    <div class="row">
                        ...
                        <div class="col" style="padding: 20px;">
                            <label for="">First name</label>
                            <input type="text" class="form-control" name="f_name" id="addf_name">
                        </div>
                        <div class="col" style="padding: 20px;">
                            <label for="">Middle name</label>
                            <input type="text" class="form-control" name="m_name" id="addm_name">
                        </div>
                        <div class="col" style="padding: 20px;">
                            <label for="">Last name</label>
                            <input type="text" class="form-control" name="l_name" id="addl_name">
                        </div>
                        <div class="col" style="padding: 20px;">
                            <label for="">Suffix</label>
                            <input type="text" class="form-control" name="suffix" id="addsuffix">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col" style="padding: 20px;">
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-success"><a href="dental.php" style="color: white;text-decoration:none;">Dental Records</a></button>
            <button class="btn btn-primary"><a href="denstudent.php" style="color: white;text-decoration:none;">+ Add Student</a></button>
            <button class="btn btn-primary"><a href="denfaculty.php" style="color: white;text-decoration:none;">+ Add Faculty</a></button>
            <button class="btn btn-primary"><a href="denstaff.php" style="color: white;text-decoration:none;">+ Add Staff</a></button>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td style="display: none;"><?= $row['blood_pressure'] ?></td>
                                    <td><?= $row['findings'] ?></td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success addmed">+ Den</button>
                                    </td>
                                </tr>
                            <?php }
                            mysqli_close($conn);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.addmed').on('click', function() {
                ...
                $('#gen_id').val(data[0])
                $('#addl_name').val(data[2]);
                $('#addf_name').val(data[3]);
                $('#addm_name').val(data[4]);
                $('#addsuffix').val(data[5]);
            });
