...
$clinic->add_dental_faculty_record();
...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">
                ...
                <form method="POST">
                    ...
                    <button type="submit" style="margin-left:20px" name="add_dental_faculty_rec" class="btn btn-success" data-bs-dismiss="modal">+ Save</button>
                    <br><br>
                </form>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary"><a href="dental.php" style="color: white;text-decoration:none;">Dental Records</a></button>
            <button class="btn btn-primary"><a href="denstudent.php" style="color: white;text-decoration:none;">+ Add Student</a></button>
            <button class="btn btn-success"><a href="medfaculty.php" style="color: white;text-decoration:none;">+ Add Faculty</a></button>
