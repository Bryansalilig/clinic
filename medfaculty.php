...
$clinic->add_medical_record_faculty();
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">
                ...
                <form method="POST">
                    ...
                    <button type="submit" style="margin-left:20px" name="add_medical_rec_faculty" class="btn btn-success" data-bs-dismiss="modal">+ Save</button>
                    <br><br>
                </form>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success editfaculty">+ Add</button>
                                    </td>
                                </tr>
                            <?php }
                            mysqli_close($conn);
