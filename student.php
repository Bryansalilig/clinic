...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary addstudent">+ Add Student</button>
            <button class="btn btn-primary"><a href="print_faculty.php?id=Student" style="color: white;text-decoration:none">Print</a></button>
...
<table class="table" style="font-size: 20px;">
        ...
        <tbody>
            ...
            <td style="display: none;"><?= $row['id']?></td>
                ...
                <td>
                <button type="button" class="btn btn-success editstudent">Edit</button>
