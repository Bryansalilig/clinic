...
$output = '';
$sql = "SELECT * FROM tbl_patient_record WHERE f_name LIKE '{$_POST['search']}%' and access = 'Staff'";
...
<table class="table" style="font-size: 20px;">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <td>
        <button type="button" class="btn btn-success"><a href="editstaff.php?id='.$row['id'].'" style="color:white;text-decoration:none;">Edit</a></button>
        <button type="button" class="btn btn-danger"><a href="deletestaff.php?id='.$row['id'].'" style="color:white;text-decoration:none;">Delete</a></button>
        </td>
    </tr>
