...
<?php foreach($staffs as $staff){?>
  <div class="row">
    <input type="hidden" name="student_id" id="staff_id" value="<?= $staff['id']?>">
  ...
  <label for="">Course</label>
      <select name="course" id="course" class="form-control">
        ...
        <button type="submit" style="margin-left:20px" name="update_student" class="btn btn-success">Update</button>
       <br><br>  
       <?php } ?>
</form>
