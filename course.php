...
$clinic->add_course();
$clinic->update_course();
$clinic->delete_course();
include("connect.php");
...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM tbl_course") or die(mysqli_error($conn));
...
// query stirng
$sql = "SELECT * FROM tbl_course LIMIT $offset, $total_records_per_page";
// result
...
<body>
  ...
  <div class="row">
    ...
    <label for="">Abbreviation</label>
      <input type="text" class="form-control" name="abb" id="abb">
    </div>
  </div>
  
        <button type="submit" style="margin-left:20px" name="update_course" class="btn btn-success" data-bs-dismiss="modal">Update</button>
       <br><br>  
</form>
    ...
    <div class="modal" id="delmodal" tabindex="1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                <button type="submit" style="margin-left:20px" name="delete_course" class="btn btn-success" data-bs-dismiss="modal">Yes</button>
  ...
  <div class="row">
    ...
    <div class="col" style="padding: 20px;">
    <label for="">Abbreviation</label>
      <input type="text" class="form-control" name="abb" placeholder="Abbreviation">
    </div>
  </div>

        <button type="submit" style="margin-left:20px" name="add_course" class="btn btn-success" data-bs-dismiss="modal">+ Add</button>
       <br><br>  
</form>
...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary addfaculty">+ Add Course</button>
