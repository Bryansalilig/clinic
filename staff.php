...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM tbl_patient_record WHERE access = 'Staff'") or die(mysqli_error($conn));
...
// query stirng
$sql = "SELECT * FROM tbl_patient_record WHERE access = 'Staff' LIMIT $offset, $total_records_per_page";
// result
...
<body>
  ...
  <label for="">Patient Type</label>
    ...
    <div class="col" style="padding: 20px;">
        ...
        <button type="submit" style="margin-left:20px" name="update_staff" class="btn btn-success" data-bs-dismiss="modal">Update</button>
       <br><br>  
</form>
    ...
    <div class="modal" id="delmodal" tabindex="1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST">
                    <center><br>
                    <input type="hidden" name="delstaff_id" id="delstaff_id">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                <button type="submit" style="margin-left:20px" name="delete_staff" class="btn btn-success" data-bs-dismiss="modal">Yes</button>
  ...
  <label for="">Patient Type</label>
    ...
    <div class="col" style="padding: 20px;">
        ...
        <button type="submit" style="margin-left:20px" name="add_staff" class="btn btn-success" data-bs-dismiss="modal">+ Add</button>
       <br><br>  
</form>
...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary addstaff">+ Add Staff</button>
            <button class="btn btn-primary"><a href="print_faculty.php?id=Staff" style="color: white;text-decoration:none">Print</a></button>
...
<table class="table" style="font-size: 20px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <button type="button" class="btn btn-success editstaff">Edit</button>
