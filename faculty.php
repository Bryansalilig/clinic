...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM tbl_patient_record WHERE access = 'Faculty'") or die(mysqli_error($conn));
...
// query stirng
$sql = "SELECT * FROM tbl_patient_record WHERE access = 'Faculty' LIMIT $offset, $total_records_per_page";
// result
...
<body>
    ...
    <div class="modal" id="modalfaculty" tabindex="1" role="dialog">
  ...
  <label for="">Patient Type</label>
    ...
    <div class="col" style="padding: 20px;">
        ...
        <button type="submit" style="margin-left:20px" name="update_faculty" class="btn btn-success" data-bs-dismiss="modal">Update</button>
       <br><br>  
</form>
    ...
    <div class="modal" id="delmodal" tabindex="1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST">
                    <center><br>
                    <input type="hidden" name="delfaculty_id" id="delfaculty_id">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                <button type="submit" style="margin-left:20px" name="delete_faculty" class="btn btn-success" data-bs-dismiss="modal">Yes</button>
  ...
  <label for="">Patient Type</label>
    ...
    <div class="col" style="padding: 20px;">
        ...
        <button type="submit" style="margin-left:20px" name="add_faculty" class="btn btn-success" data-bs-dismiss="modal">+ Add</button>
       <br><br>  
</form>
...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary addfaculty">+ Add Faculty</button>
            <button class="btn btn-primary"><a href="print_faculty.php?id=Faculty" style="color: white;text-decoration:none">Print</a></button>
...
<table class="table" style="font-size: 20px;">
        ...
        <tbody>
            ...
            <td style="display: none;"><?= $row['id']?></td>
                ...
                <td>
                <button type="button" class="btn btn-success editfaculty">Edit</button>
                <button type="button" class="btn btn-danger deletefaculty">Delete</button>
                </td>
            </tr>
            <?php }
            mysqli_close($conn);
