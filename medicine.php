...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM tbl_medicine") or die(mysqli_error($conn));
...
// query stirng
$sql = "SELECT * FROM tbl_medicine LIMIT $offset, $total_records_per_page";
// result
...
<body>
    ...
    <div class="modal" id="modalmedicine" tabindex="1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">

                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">EDIT/ADD STOCKS</h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" style="margin-left:20px" name="delete_medicine" class="btn btn-success" data-bs-dismiss="modal">Yes</button>
    ...
    <div class="modal" id="addmedmodal" tabindex="1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col" style="padding: 20px;">
                            <label for="">Medicine name</label>
                            <input type="text" class="form-control" name="med_name" placeholder="Enter Medicine name">
                        </div>
                        <div class="col" style="padding: 20px;">
                            <label for="">Cure for/Description</label>
                    ...
                    <button type="submit" style="margin-left:20px" name="add_medicine" class="btn btn-success" data-bs-dismiss="modal">+ Add</button>
                    <br><br>
                </form>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-primary addmedicine">+ Add Medicine</button>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td><?= $row['ex_date'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success editfaculty">+ Stocks</button>
