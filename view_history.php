...
$all_recs = $clinic->select_all_mul_rec($id);
?>
...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <nav>
                <div class="logo">
                    <p><?= $record['f_name']?> RECORDS</p>
                </div>
            </nav><br><br><br><br>
            <button class="btn btn-primary"><a href="patient_history.php" style="color: white;text-decoration:none">Back</a></button>
                    ...
                    <table class="table" style="font-size: 20px;">
                        ...
                        <?php if($all_recs > 0){?>
                            ...
                            <?php foreach($all_recs as $all_rec){?>
                                <td><?= $all_rec['consult_type']?></td>
                                <td><?= $all_rec['findings']?></td>
                                <td><?= $all_rec['medication']?></td>
                                <td><?= $all_rec['consult_date']?></td>
                                <td><?= $all_rec['phy']?></td>
                           </tr>
                           <?php } }?>
                        </tbody>
