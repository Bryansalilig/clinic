...
$result_count = mysqli_query($conn, "SELECT COUNT(*) as total_records FROM medical_records") or die(mysqli_error($conn));
...
// query stirng
$sql = "SELECT * FROM medical_records LIMIT $offset, $total_records_per_page";
// result
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="padding: 20px;">
                            ...
                            <?php foreach($courses as $course){?>
                                <option value="<?= $course['abb']?>"><?= $course['abb']?></option>
                                <?php } ?>
                            </select>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 140%;">
                ...
                <form method="POST">
                    ...
                    <button type="submit" style="margin-left:20px" name="add_mul_medical" class="btn btn-success" data-bs-dismiss="modal">+ Save</button>
                    <br><br>
    ...
    <section class="home">
        <div class="text">
            ...
            <button class="btn btn-success"><a href="medical.php" style="color: white;text-decoration:none;">Medical Records</a></button>
            <button class="btn btn-primary"><a href="medstudent.php" style="color: white;text-decoration:none;">+ Add Student</a></button>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success addmed">+ Med</button>
                                    </td>
                                </tr>
                            <?php }
                            mysqli_close($conn);
