...
<script>
    ...
    <section class="home">
        <div class="text">
            ...
            <nav>
                <div class="logo">
                    <p>Patient Dental History</p>
                </div>
            </nav><br><br><br><br>
            <button type="button" class="btn btn-primary"><a href="patient_history.php" style="color: white;text-decoration:none">Medical History</a></button>
            <button type="button" class="btn btn-success"><a href="patient_history_dental.php" style="color: white;text-decoration:none">Dental History</a></button>
...
<table class="table" style="font-size: 20px;">
        ...
        <tbody>
            ...
            <td style="display: none;"><?= $row['med_id']?></td>
                ...
                <td><?= $row['phy']?></td>
                <td>
                <button type="button" class="btn btn-success"><a href="view_dental_history.php?id=<?= $row['dental_id']?>" style="color: white;text-decoration:none">History</a></button>
                </td>
            </tr>
            <?php }
            mysqli_close($conn);
